...
lint-flake8:
	...
	@$(POETRY) run flake8 aiotelegraf tests
	@echo "\033[92m> done\033[0m"
	@echo
...
lint-mypy:
	...
	@$(POETRY) run mypy --ignore-missing-imports --follow-imports=silent aiotelegraf tests
	@echo "\033[92m> done\033[0m"
	@echo
...
.PHONY: test
test:
	@$(POETRY) run pytest --cov-report=term --cov-report=html --cov-report=xml --cov=aiotelegraf -vv $(opts)
